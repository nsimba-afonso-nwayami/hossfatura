          ...
          <div className="w-full max-w-md">
            ...
            <div className="mb-10 text-center lg:text-left">
              ...
              <p className="text-neutral-500 mt-3 text-sm leading-relaxed">
                Acesse o painel de faturação, stock e gestão da sua empresa.
              </p>
            </div>
            ...
            <form className="space-y-5">
              ...
              <div className="flex justify-between text-xs text-neutral-500 mt-4">
                <Link to="/recuperar" className="hover:text-amber-700 transition-colors">
                  Esqueceu a senha?
                </Link>

                <Link to="/criar-conta" className="hover:text-amber-700 transition-colors">
                  Criar conta
                </Link>
              </div>
