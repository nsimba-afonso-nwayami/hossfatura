...
export default function FormDemonstracao() {
  const provincias = [
    "Bengo",
    "Benguela",
    "Bié",
          ...
          <div className="flex flex-col gap-8">
            <div>
              ...
              <h2 className="text-4xl lg:text-5xl font-extrabold tracking-tight leading-tight">
                ...
                <span className="text-amber-700 italic">personalizada</span>
              </h2>

              <p className="text-neutral-500 mt-6 text-lg leading-relaxed max-w-xl">
                Um especialista irá apresentar o sistema ideal para a realidade
                do seu negócio em Angola, mostrando funcionalidades, planos e
            ...
            <div className="space-y-5">
              {[
                ...
                "Análise do seu tipo de negócio",
                "Demonstração adaptada à sua empresa",
                "Suporte local e implementação assistida",
              ].map((item, index) => (
                <div
                  key={index}
            ...
            <div className="bg-white border border-neutral-200 rounded-3xl p-8 shadow-sm">
              ...
              <p className="text-neutral-500 leading-relaxed text-sm">
                Após o envio do formulário, a nossa equipa entra em contacto
                consigo para agendar a melhor data e horário para a sua
                demonstração.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white border border-neutral-200 rounded-4xl p-8 lg:p-10 shadow-[0_20px_40px_-20px_rgba(0,0,0,0.08)]">
            <form className="space-y-6">
              ...
              <div>
                ...
                <select
                  className="w-full h-14 px-5 rounded-2xl border border-neutral-200 bg-neutral-50 outline-none focus:border-amber-700 transition-all cursor-pointer"
                >
