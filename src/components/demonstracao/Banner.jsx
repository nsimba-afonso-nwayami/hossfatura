...
import Demonstracao from "../../assets/img/demonstracao.jpg";
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col gap-8">
            ...
            <nav className="flex items-center gap-3 text-xs font-bold uppercase tracking-widest text-zinc-500">
              ...
              <span className="text-amber-600">Demonstração</span>
            </nav>
            ...
            <h1 className="text-5xl lg:text-7xl font-extrabold leading-[1.05] tracking-tighter">
              Veja o sistema em{" "}
              <span className="text-amber-600 italic">ação.</span>
            </h1>

            {/* Texto */}
            <p className="text-zinc-400 text-lg lg:text-xl leading-relaxed max-w-xl">
              Agende uma demonstração completa do HossFatura e descubra como
              modernizar a gestão da sua empresa com eficiência, controlo e
              conformidade fiscal.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              ...
              >
                ...
                <div className="bg-white/5 p-1 rounded-md group-hover:bg-white/10 transition-colors">
                  <i className="fas fa-display text-[10px] text-zinc-500 group-hover:text-amber-500"></i>
                </div>
              </Link>
            </div>
          </div>
