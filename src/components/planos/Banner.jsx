...
import Planos from "../../assets/img/planos.jpg";
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col gap-8">
            ...
            <nav className="flex items-center gap-3 text-xs font-bold uppercase tracking-widest text-zinc-500">
              ...
              <span className="text-amber-600">Planos</span>
            </nav>
            ...
            <h1 className="text-5xl lg:text-7xl font-extrabold leading-[1.05] tracking-tighter">
              ...
              <span className="text-amber-600 italic">negócio.</span>
            </h1>

            {/* Texto */}
            <p className="text-zinc-400 text-lg lg:text-xl leading-relaxed max-w-xl">
              Soluções flexíveis para pequenas, médias e grandes empresas em
              Angola. Pague apenas pelo que realmente precisa.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              ...
              >
                ...
                <div className="bg-white/5 p-1 rounded-md group-hover:bg-white/10 transition-colors">
                  <i className="fas fa-calendar-check text-[10px] text-zinc-500 group-hover:text-amber-500"></i>
                </div>
              </Link>
            </div>
          </div>
